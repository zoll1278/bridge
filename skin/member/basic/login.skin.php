...
<div id="login_wrap">
    <div class="login_wrap">
        ...
        <div class="inner">
            ...
            <div class="header">
                <div class="title">BRIDGE 시작하기</div>
                <div class="text">BRIDGE과 함께 <span>AI 무한가능성</span>을 체험해 보세요</div>
            </div>
            <div class="content">
                <div class="form">
                    <dl>
                        <dt><label for="login_id">아이디</label></dt>
                        <dd>
                            <div class="input">
                                <input type="text" name="mb_id" id="login_id" required size="20" maxLength="20" placeholder="이메일 주소를 입력해주세요">
                            </div>
                        </dd>
                    </dl>
                    <dl>
                        <dt><label for="login_pw">비밀번호</label></dt>
                        <dd>
                            <div class="input">
                                <input type="password" name="mb_password" id="login_pw" required size="20" maxLength="20" placeholder="비밀번호를 입력해주세요">
                            </div>
                ...
                <div class="button">
                    <button type="submit" id="submitBtn" class="btn_submit" disabled>로그인</button>
                </div>
                <div class="find">
                ...
                <script>
                    ...
                    $("#login_wrap .form").on("input", function(){
                        if($("input[name='mb_id']").val() != '' && $("input[name='mb_password']").val() != '') {
    ...
    <div class="bottom_wrap" style="display:flex">
        <div class="flex">
